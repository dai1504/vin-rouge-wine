...
if ($(".js-wrap-box").length) {
	const paralax = $('.js-wrap-box');
	for( i=0; i< paralax.length; i++ ) {
		paralax[i].classList.add('js-wrap-box-' + i);
		new FxWrap('.js-wrap-box-' + i);
		new ObGroupManager('.js-wrap-box-' + i);
	}
	// $('.js-wrap-box').each(function() {
